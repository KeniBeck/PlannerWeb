...
interface AddClientDialogProps {
  ...
  client?: Client; // Si se proporciona, es para editar
  onSave?: (client: Omit<Client, "id"> & { id?: number }) => void;
}

export function AddClientDialog({ open, onOpenChange, client, onSave }: AddClientDialogProps) {
  ...
  // Restablecer el formulario cuando se abre/cierra o cambia el cliente
  useEffect(() => {
    if (open) {
      setFormData({
        id: client?.id || undefined,
