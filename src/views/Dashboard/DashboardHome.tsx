...
export default function DashboardHome() {
  ...
  const inProgressOperations = operations.filter(
    (op) => op.status === OperationStatus.INPROGRESS
  ).length;
          ...
          <div className="mt-4 relative pt-2">
            <div className="flex w-full h-4 bg-gray-100 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${(pendingOperations / operations.length) * 100}%`,
                }}
              ></div>
              <div
                className="bg-orange-500 h-full"
                style={{
                  width: `${(inProgressOperations / operations.length) * 100}%`,
                }}
              ></div>
              <div
                className="bg-green-500 h-full"
                style={{
                  width: `${(completedOperations / operations.length) * 100}%`,
                }}
              ></div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="w-full bg-gray-100 rounded-full h-2.5">
              <div
                ...
                style={{
                  width: `${(availableWorkers / workers.length) * 100}%`,
                }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-100 rounded-full h-2.5">
              <div
                ...
                style={{
                  width: `${(assignedWorkers / workers.length) * 100}%`,
                }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-100 rounded-full h-2.5">
              <div
                ...
                style={{
                  width: `${(incapacitatedWorkers / workers.length) * 100}%`,
                }}
              ></div>
            </div>
          </div>
